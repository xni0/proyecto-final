...
export default function Navbar() {
  ...
  const renderAuthButtons = () => {
    if (isAuthenticated) {
      ...
      return (
        <>
          <span className="text-secondary-light font-semibold text-[0.95rem]">👤 {user?.username}</span>
